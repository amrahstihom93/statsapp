"""
Base Django settings for statsproject.
Environment-specific settings live in local.py / production.py
"""
...
if DB_ENGINE == 'django.db.backends.sqlite3':
    ...
    DATABASES = {
        'default': {
            'ENGINE': DB_ENGINE,
            'NAME': config('DB_NAME', default='statistics3'),
...
# ── CORS / CSRF config for React frontend ───────────────────────────────────
...
# Session & CSRF cookies for local cross-origin development
